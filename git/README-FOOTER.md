...
> These are links to my projects I append to `README.md` files of my public projects.
...
**🔐 [Encrypted Chat](https://chat.datafury.io)** Ephemeral, end-to-end encrypted messaging across devices with no accounts, no central storage, and zero trust requirements.
...
**☀️ [Plug-in Solar Comparison](https://plugin-solar.datafury.io)** Compare G98-compliant UK plug-in solar kits by peak panel output, upfront price, and value per watt.
